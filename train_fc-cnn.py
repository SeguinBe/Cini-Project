...
ap.add_argument("--nb-epochs", default=20, help="Number of epochs")
...
for i in trange(args['nb_epochs']):
    # Train for one epoch
    estimator.train(input.input_fn(train_images_dir, train_labels_dir, num_epochs=1, data_augmentation=True))
    # Evaluate
